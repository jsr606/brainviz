...
public class brainVizP53D extends PApplet {
...
int startIndex = 500, endIndex = 800;

float xStep;

float graphSize = 200, strokeW = 0.5f;
...
public void justDrawData() {
	...
	for (int j = 0; j<4; j++) {
		...
		xStep = PApplet.parseFloat(width)/(endIndex-startIndex);
		strokeWeight(xStep*0.8f);
...
public void controlEvent(ControlEvent theControlEvent) {
  if(theControlEvent.isFrom("rangeController")) {
    ...
    startIndex = PApplet.parseInt(theControlEvent.getController().getArrayValue(0));
    endIndex = PApplet.parseInt(theControlEvent.getController().getArrayValue(1));
...
public void mouseReleased() {
	...
	if (mouseArmed) {	
		...
		startIndex = PApplet.parseInt(map(dragXMin, 0, width, startIndex, endIndex));
		endIndex = PApplet.parseInt(map(dragXMax, 0, width, startIndex, endIndex));
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "brainVizP53D" };
    if (passedArgs != null) {
